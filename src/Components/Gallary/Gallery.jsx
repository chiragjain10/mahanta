  ...
  return (
    <div ref={ref} className="gallery-section-container" id={sectionId}>
      <div className="gallery-section-header">
        ...
        <p className="section-subtitle text-center">Explore our curated collection of memorable moments</p>
      </div>
...
const Gallery = () => {
  ...
  return (
    <div className="gallery-page-wrapper">
      ...
      <GalleryBreadcrumbs currentSection={currentSection} />

      {/* Hero Banner */}
      <section className="gallery-hero">
        <div className="container">
          <div className="hero-content-wrapper">
            <h1 className="gallery-hero-title py-4 mt-3">Event Gallery</h1>
            <p className="gallery-hero-subtitle">
              Explore our journey through moments of achievement, celebration, and collaboration. 
              Each image tells a story of our growth and success.
            </p>
          </div>
        </div>
      </section>
